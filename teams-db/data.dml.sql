...
INSERT INTO teams (name) VALUES
	('Formateurs'), ('Pédagogique');
	
INSERT INTO members (first_name, last_name, home_address_id) VALUES
	('Jérémy', 'BOJKO', (SELECT t.id FROM addresses t WHERE t.road = '14 Rue de la Beaune')),
...
INSERT INTO teams_members VALUES 
	...
	((SELECT t.id FROM teams t WHERE t.name = 'Pédagogique'), (SELECT t.id FROM members t WHERE t.last_name = 'LUONG')),
	((SELECT t.id FROM teams t WHERE t.name = 'Pédagogique'), (SELECT t.id FROM members t WHERE t.last_name = 'DAUGUET'));
